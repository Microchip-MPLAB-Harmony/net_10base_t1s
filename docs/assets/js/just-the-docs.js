...
{"0": {
    ...
    "url": "http://localhost:4000/net_10base_t1s/mplab_harmony_license.html",
    ...
    "content": "The parent folder for all the MPLAB X IDE projects for this application is given below: . Application Path : net_10base_t1s\\\\apps\\tcpip_iperf_10base_t1s\\firmware . To build the application, refer to the table below and open the appropriate project file in MPLABX IDE. | Project Name | Description | . | tcpip_iperf_10base_t1s.X | TCP/IP Client using the LAN867x 10BASE-T1S Ethernet PHY | . | tcpip_iperf_10base_t1s_freertos.X | TCP/IP Client using the LAN867x 10BASE-T1S Ethernet PHY in FreeRTOS environment | . ",
    ...
    "content": ". | Hardware used . | Sam E54 Curiosity Ultra | RMII to 10BASE-T1S interface card | . | Hardware setup . | Connect the DEBUG USB port on the board to the computer using a micro USB cable | Connect the RMII to 10BASE-T1S interface card to another 10BASE-T1S node (e.g. a second instance of this setup) | . | . ",
    ...
    "doc": "TCP/IP Client using the LAN867x 10BASE-T1S Ethernet PHY",
    "title": "Harmony 3 Settings for LAN867x",
    "content": "GMAC Settings . 10BASE-T1S is a 10 Mbps, half-duplex network. Therefore, the GMAC must be configured accordingly to: . | 10 Mbps | Half Duplex | Auto Negotiation - Disabled | MDIX - Disabled | . PLCA Settings . 10BASE-T1S can be used in PLCA or CSMA/CD mode. When using PLCA, the parameters for Local Node ID, Node Count, Max Burst Count and Burst Timer must be configured. ",
    "url": "http://localhost:4000/net_10base_t1s/apps/tcpip_iperf_10base_t1s/readme.html#harmony-3-settings-for-lan867x",
    "relUrl": "/apps/tcpip_iperf_10base_t1s/readme.html#harmony-3-settings-for-lan867x"
  },"8": {
    "doc": "TCP/IP Client using the LAN867x 10BASE-T1S Ethernet PHY",
    "title": "Harmony 3 Settings for FreeRTOS",
    "content": "Note: The following settings applicable only for FreeRTOS application. For Bare Metal application, the below settings are not required. SERCOM Settings . Set the SERCOM RX and TX buffer size as 4096. CORE Settings . According to the application update the Task delay field. SYSTEM Settings . In the System configuration update the heap size as 96960 bytes (based on the application). SYSTEM COMMAND Settings . In SYSTEM COMMAND configure the required stack size for the application. In this case 10240 bytes. ",
    "url": "http://localhost:4000/net_10base_t1s/apps/tcpip_iperf_10base_t1s/readme.html#harmony-3-settings-for-freertos",
    "relUrl": "/apps/tcpip_iperf_10base_t1s/readme.html#harmony-3-settings-for-freertos"
  },"9": {
    "doc": "TCP/IP Client using the LAN867x 10BASE-T1S Ethernet PHY",
    ...
    "content": " ",
    "url": "http://localhost:4000/net_10base_t1s/release_notes.html#microchip-mplab-harmony-3-release-notes",
    "relUrl": "/release_notes.html#microchip-mplab-harmony-3-release-notes"
  },"12": {
    "doc": "Release notes",
    "title": "10BASE-T1S Release v1.1.0",
    "content": "New Features . New features added in this release are as follows: . | Added FreeRTOS example project for LAN867x. | . Release notes for v1.0.1 apply . ",
    "url": "http://localhost:4000/net_10base_t1s/release_notes.html#10base-t1s-release-v110",
    "relUrl": "/release_notes.html#10base-t1s-release-v110"
  },"13": {
    "doc": "Release notes",
    "title": "10BASE-T1S Release v1.0.1",
    "content": "Bug Fixes . The following table provides the list of bug fixes in the v1.0.1 release: . | Module | Description | . | LAN867x | Use correct data type for initialState | . | Release notes for v1.0.0 apply | . ",
    "url": "http://localhost:4000/net_10base_t1s/release_notes.html#10base-t1s-release-v101",
    "relUrl": "/release_notes.html#10base-t1s-release-v101"
  },"14": {
    "doc": "Release notes",
    "title": "10BASE-T1S Release v1.0.0",
    "content": "New Features . | New device support - This release introduces support for . | Device | Description | . | LAN867x | 10BASE-T1S Ethernet PHY | . | Demo application support - The following table provides a list of of new applications . | Application | Platform | Description | . | tcpip_iperf_10base_t1s | SAM E54 | TCP/IP Client using the LAN867x 10BASE-T1S Ethernet PHY | . | Development kit support - The following table provides a list of supported development kits . | Development Kits | . | SAM E54 Curiosity Ultra Development Board | . In addition to the listed development kits above, a 10BASE-T1S PHY RMII Card is required. Please contact 10BASE-T1S Support for more information. | . Known Issues . | No known issues | . Dependencies . | MPLAB® X IDE v5.45 or later | MPLAB® XC32 C/C++ Compiler v2.50 or later | net v3.7.2 or later | . ",
    "url": "http://localhost:4000/net_10base_t1s/release_notes.html#10base-t1s-release-v100",
    "relUrl": "/release_notes.html#10base-t1s-release-v100"
  },"15": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": ". ",
